...
def validate_quarter(quarter):
    if quarter in ('Q1', 'Q2', 'Q3', 'Q4'):
        return True
    print('Invalid input. Q1, Q2, Q3, or Q4')
    return False

while True:
    try:
        quarter = input('What Quarter are you monitoring? (Q1, Q2, Q3, or Q4)')
...
#  deaths
deathless90 = int(less90data[33][1])
deathmore90 = int(more90data[33][1])
...
annualbenies = int(bdata[2][2])
exitbennies = int(bdata[2][3])
print('Households receving mainstream benefits: ', entrybennies + annualbenies + exitbennies)
...
print('Total Housholds with a chronically homeless member:', chfam)
...
print('Veterans Sereved:', (chvet+nonchvet))
